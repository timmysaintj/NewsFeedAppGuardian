...
public final class QueryUtils {
        ...
        try {
            ...
            for (int i = 0; i < results.length(); i++) {
                ...
                try {
                    ...
                    Log.e(LOG_TAG, "Problem getting bitmap from URL.", e);
                }
    ...
    public static List<Article> fetchArticleUrl(String requestURL) {
    ...
    private static Bitmap getBitmapFromURL(String imageUrl) throws IOException {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Problem with bitmap form URL.", e);
            return null;
        } finally {
            if (connection != null) {
